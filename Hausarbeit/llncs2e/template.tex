...
Ein Schwerpunkt bei den Erweiterungen des Protokolls ist Performanz. Verbesserungen in der Performanz erreicht man durch effiziente Nutzung des unterliegenden Transportprotokolls. HTTP/1.1 erlaubt Pipe\-lining von mehreren Anfragen auf einer TCP-Verbindung. Beim Pipe\-lining tritt das Problem HOL-Blocking auf. Das wird in \mbox{HTTP/2} durch Multiplexing umgangen.  Die prominenteste Anwendung, die HTTP nutzt, ist das World Wide Web, das auf dem Internet aufsitzt.
